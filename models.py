...
class Person(Base):
    ...
    family_name = Column(VARCHAR(1024), nullable=False)
...
class Organization(Base):
    ...
    is_pir = Column(Integer, nullable=False)
    is_smr_gvd_gnd = Column(Integer, nullable=False)
    is_smr_vdgo = Column(Integer, nullable=False)
    is_to_gvd_gnd = Column(Integer, nullable=False)
    ...
    ogrn = Column(VARCHAR(32), nullable=True)
    from_1c = Column(Integer, nullable=False)
    to_rg = Column(Integer, nullable=False)
    to_ggs = Column(Integer, nullable=False)
    to_gss = Column(Integer, nullable=False)
    to_ggsi = Column(Integer, nullable=False)
    to_ggss = Column(Integer, nullable=False)
    to_rgs = Column(Integer, nullable=False)
